...
class VehiclesCard extends StatelessWidget {
  ...
  const VehiclesCard({super.key, required this.person});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.directions_car, color: Colors.orange[400], size: 20),
            ...
            Column(
              children: person.vehicles.asMap().entries.map((entry) {
